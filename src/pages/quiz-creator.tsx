...
export default function QuizCreator() {
  ...
  const handlePublishQuiz = async () => {
    ...
    try {
      await QuizService.createCompleteQuiz(
        groupId,
        quizData.metadata,
        quizData.questions
      );
      ...
      notifyUsers(
        ...
        } has been published to your group ${
          selectedGroup?.name || ""
        }. Please check it out!`,
  ...
  return (
    <Box sx={{ bgcolor: theme.palette.background.default, minHeight: "100vh" }}>
      ...
      <Dialog open={saveDialogOpen} onClose={() => setSaveDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to save this quiz as a draft? You can continue
            editing it later.
          </Typography>
        </DialogContent>
        <DialogActions>
      ...
      >
        ...
        <DialogContent>
          <Typography paragraph>
            Are you sure you want to publish this quiz? Once published, students
            will be able to take it.
          </Typography>
          <Alert severity="info">
            Make sure all questions are correct and the quiz is ready for
            students.
          </Alert>
        ...
        <DialogActions>
          ...
          <Button
            ...
            disabled={isPublishing}
            startIcon={
              isPublishing ? <CircularProgress size={16} /> : undefined
            }
          >
